...
/*
 * StartChannelException.java            $Revision: 1.2 $ $Date: 2001/11/08 05:51:34 $
 *
...
public class StartChannelException extends BEEPError {
     ...
     *
     */
    public StartChannelException(int code, String diagnostic, String xmlLang)
    {
     ...
     *
     */
    public StartChannelException(int code, String diagnostic)
    {
